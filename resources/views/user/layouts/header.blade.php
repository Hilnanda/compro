<header id='header'
    ...
    role="banner" itemscope="itemscope">
    ...
    <div id='header_meta'
        class='container_wrap container_wrap_meta  av_phone_active_right av_extra_header_active av_entry_id_9'>
                    ...
                    <div class="avia-menu av-main-nav-wrap">
                        <ul id="avia-menu" class="menu av-main-nav">
                            ...
                            <li id="menu-item-545"
                                ...
                                <a href="/" ><span
                                        class="avia-bullet"></span><span class="avia-menu-text">HOME</span><span class="avia-menu-fx"><span class="avia-arrow-wrap"><span
                                                class="avia-arrow"></span></span></span></a>
                            </li>
                            <li id="menu-item-545"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-top-level menu-item-top-level-2">
                                <a  href="{{ route('about_us') }}" ><span
                                        class="avia-bullet"></span><span class="avia-menu-text">ABOUT US</span><span class="avia-menu-fx"><span class="avia-arrow-wrap"><span
                                                class="avia-arrow"></span></span></span></a>
                            </li>
                            <li id="menu-item-545"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-top-level menu-item-top-level-2">
                            ...
                            <li id="menu-item-545"
                                ...
                                <a  href="{{ route('contact_us') }}" ><span
                                        class="avia-bullet"></span><span class="avia-menu-text">CONTACT US</span><span class="avia-menu-fx"><span class="avia-arrow-wrap"><span
                                                class="avia-arrow"></span></span></span></a>
                            </li>
                            <li id="menu-item-545"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-top-level menu-item-top-level-2">
                                <a  href="{{ route('news') }}" ><span
                                        class="avia-bullet"></span><span class="avia-menu-text">NEWS</span><span class="avia-menu-fx"><span class="avia-arrow-wrap"><span
                                                class="avia-arrow"></span></span></span></a>
                            </li>
